...
__attribute__ ((section(".bootloaderSettings"))) uint8_t m_boot_settings[1024] = {BANK_VALID_APP};
__attribute__ ((used, section(".uicrBootStartAddress"))) uint32_t m_uicr_bootloader_start_address = BOOTLOADER_REGION_START;
